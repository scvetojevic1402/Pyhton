#THIS SCRIPT FINDS POLYGONS OF SHAPEFILES WHOSE CENTROIDS FALL WITHIN POLYGONS OF ANOTHER SHAPEFILE
#AND INSERTS THOSE POLYGONS INTO A POSTGRESQL DATABASE
import fiona
import pprint,os
